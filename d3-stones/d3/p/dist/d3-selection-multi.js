...
var selection_fastattrs = function(attributes) {
  if (typeof attributes === "object") {
    for (let name in attributes) {
      var fullname = name; //not defined?
      this.each(
        
          setAttribute(fullname, attributes[fullname])
        );
    };
    return this;
  }
...
d3Selection.selection.prototype.fastattrs = selection_fastattrs;
